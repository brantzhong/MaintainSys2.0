...
$(function(){
    ...
    $UncomplishTab.on('click', function () {
        ...
        FetchUserRecord(sessionStorage.getItem("UserID"),LoadTimes_tab2,"complete",function(RequestData){
    ...
    $Tab1.infinite().on("infinite", function() {
        ...
        FetchUserRecord(sessionStorage.getItem("UserID"),LoadTimes_tab1,"uncomplete",function(RequestData){
...
function FetchUserRecord(UserID,LoadTimes,Option,CallBackFunc)
{
    var url = "http://2278i36g67.iok.la/MaintainSys/src/php/FetchMyRecord.php";
